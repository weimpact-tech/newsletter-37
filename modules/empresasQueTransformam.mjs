...
var textoArray = obj.empresasQueTransformam.texto;
var textoFinal = "";
...
var textoListaArray = obj.empresasQueTransformam.textoLista;
var textoListaFinal = "";
...
export var htmlEmpresasQueTransformam =
  "<!-- BEGIN #EMPRESASQUETRANSFORMAM // -->" +
  os.EOL +
  ...
  os.EOL +
  obj.empresasQueTransformam.tituloSecao +
  os.EOL +
  "</h3>" +
  os.EOL +
  '<img src="' +
  obj.empresasQueTransformam.img +
  '"' +
  os.EOL +
  ...
  os.EOL +
  obj.empresasQueTransformam.titulo +
  os.EOL +
  "</p>" +
  os.EOL +
  textoFinal +
  ...
  "style=\"-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; text-align: left; padding-left: 20px; padding-right: 20px; font-size: 16px; font-family: 'Open Sans', sans-serif; margin: 25px 0px 20px; color: white;\">" +
  os.EOL +
  obj.empresasQueTransformam.tituloLista +
  os.EOL +
  "</p>" +
  os.EOL +
  ...
  os.EOL +
  '<a href="' +
  obj.empresasQueTransformam.linkBotao +
  '"' +
  os.EOL +
  'target="_blank"' +
  os.EOL +
  ...
  os.EOL +
  obj.empresasQueTransformam.botao +
  os.EOL +
  "</button>" +
  os.EOL +
  "</a>" +
